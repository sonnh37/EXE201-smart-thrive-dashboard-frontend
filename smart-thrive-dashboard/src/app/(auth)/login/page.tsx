...
import AuthenForm from "@/components/sections/authen";
import AuthSlider from "@/components/sections/authen";
      ...
      <div className="flex flex-col p-10 h-3/6 w-3/5 bg-transparent relative overflow-hidden rounded-3xl">
        ...
        <div className="w-full z-10">
          <Image
            ...
            height={50}
            alt="Gallery Icon"
            className="rounded-full mb-4 aspect-square object-cover bg-gradient-to-r from-indigo-500 to-sky-500"
          />
        </div>
